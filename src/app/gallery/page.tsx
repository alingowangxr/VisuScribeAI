    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">探索由 AI 生成的各種風格配圖範例</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4 border rounded-xl overflow-hidden bg-muted/20 p-4 flex flex-col items-center justify-center h-64 border-dashed">
            ...
            <p className="text-sm font-medium text-muted-foreground italic">即將推出更多範例...</p>
          </div>
        </div>

        <div className="mt-24">
          <h3 className="text-xl font-bold mb-8 text-center">所有內置風格預覽</h3>
        ...
        <div className="mt-24 bg-primary text-primary-foreground rounded-2xl p-12 text-center">
          ...
          <p className="mb-8 opacity-90">只需輸入一段文字，AI 即可為你規劃全套視覺資產。</p>
          <Link href="/editor">
